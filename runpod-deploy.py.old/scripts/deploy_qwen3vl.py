...
"""
====================================================
DEPLOY — Pod Qwen3-VL-8B sur RunPod L40S
====================================================
Usage :
...
Ce script crée un pod RunPod Secure Cloud avec :
  ...
  - Startup : startup/startup_qwen3vl.sh (copié sur le Network Volume)
====================================================
"""
...
NETWORK_VOLUME_ID = os.getenv("NETWORK_VOLUME_ID_QWEN3", "")  # optionnel
DATACENTER       = os.getenv("PREFERRED_DATACENTER", "EU-RO-1")

POD_NAME         = "fuzzion-qwen3vl"
GPU_TYPE         = "NVIDIA L40S"
IMAGE            = "runpod/pytorch:2.4.0-py3.11-cuda12.4.1-devel-ubuntu22.04"
CONTAINER_DISK   = 50     # GB — système + pip cache
VOLUME_SIZE      = 80     # GB — modèles + données (si pas de volume existant)
VOLUME_MOUNT     = "/workspace"

# Script de démarrage (injecté comme commande Docker)
# Le script est encodé inline pour éviter toute dépendance externe
with open("startup/startup_qwen3vl.sh", "r") as f:
    STARTUP_SCRIPT = f.read()

# On encode le script en base64 pour l'injecter proprement
import base64
...
print(f"   Image       : {IMAGE}")
print(f"   Modèle      : Qwen3-VL-8B-Instruct")
...
# Attacher un Network Volume si spécifié, sinon créer un volume anonyme
...
try:
    ...
    print()
    print("📋 Logs :")
    print(f"   vLLM        : /workspace/logs/vllm_qwen3vl.log")
